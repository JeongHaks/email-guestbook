...
<%@page import="emaillist22.EmaillistVo"%>
...
<h1>메일 리스트 가입</h1>
  ...
  <form action="/emaillist/emaillist2" method="post">
  ...
  <br>
  <p>
    <a href="/emaillist/emaillist2">리스트 바로가기</a>
  </p>
...
<% if(list != null){
    ...
    <tr>
        ...
        <td><%= vo.getEmail() %></td>
        <td><a href="/emaillist/emaillist2?a=delete&no=<%=vo.getNo()%>">삭제</a></td>
    </tr>
  <% } %>
<% } %>
  </table>
